...
class HBNBCommand(cmd.Cmd):
    ...
    def emptyline(self):
        """On receipt of empty line do nothing."""
        pass
    ...
    def do_create(self, arg):
        """Usage: create <class>
        Create new class instance and print the id.
        """
        argl = parse(arg)
        if len(argl) == 0:
    ...
    def do_destroy(self, arg):
        ...
        Delete given id class instance."""
        argl = parse(arg)
        objdict = storage.all()
        if len(argl) == 0:
            print("** class name missing **")
    ...
    def do_all(self, arg):
        ...
        Display all instances string representations of given class.
        If no class is given, display all instantiated objects."""
        argl = parse(arg)
    ...
    def do_count(self, arg):
        ...
        Retrieve number of given class instances."""
        argl = parse(arg)
        count = 0
        for obj in storage.all().values():
    ...
    def do_update(self, arg):
        """ Usage: update <class> <id> <attribute_name> <attribute_value> or
            ...
            Update given id class instance by adding
