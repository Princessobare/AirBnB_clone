#!/usr/bin/python3
"""This Defines the unittests for models/city.py.
...
class TestCity_instantiation(unittest.TestCase):
    """Unittest to test City class instantiation."""
...
class TestCity_save(unittest.TestCase):
    """Unittest to test City class save method."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittest to test City class to_dict method."""
